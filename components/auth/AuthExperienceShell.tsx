    ...
    <main className="relative min-h-screen overflow-y-auto bg-[#f8f7f4] px-4 py-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-3rem)] flex-col items-center justify-start gap-3 pt-6 sm:justify-center sm:pt-0">
        <Link
          ...
          className="inline-flex flex-col items-center rounded-3xl px-4 py-2 transition hover:bg-white/45"
        >
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-orange-700 text-lg font-bold text-white shadow-sm">
            C
          </span>
